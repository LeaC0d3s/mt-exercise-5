...
cat $translations_sub/test.de-en.2000.tokenized.$model_name.$trg | $MOSES/tokenizer/detokenizer.perl -l $trg > $translations_sub/test.de-en.2000.$model_name.$trg

# compute case-sensitive BLEU on detokenized data

cat $translations_sub/test.de-en.2000.$model_name.$trg | sacrebleu $data/test.de-en.$trg
